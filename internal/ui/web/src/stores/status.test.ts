...
describe('status store', () => {
  ...
  it('dnsState reads the status field and falls back to ok for old payloads', async () => {
    ...
    const base = { nginx: { running: true }, php_fpms: [], php_default: '', node_default: '', node_managed_by_lerd: true, node_manager: 'fnm' as const, bun_available: false, bun_version: '', using_system_bun: false, watcher_running: true, frankenphp_php_versions: [], home: '' };
