...
<aside
  class="hidden md:flex flex-col items-center w-14 shrink-0 min-h-0 bg-white dark:bg-lerd-card border-r border-gray-200 dark:border-lerd-border py-3 z-20"
>
  <RailLogo />
  ...
  {#if !remote}
    <div
      class="flex flex-col items-center gap-1 mt-3 pt-3 border-t border-gray-200 dark:border-lerd-border w-8 min-h-0 flex-1 overflow-y-auto overscroll-contain no-scrollbar"
    >
      <IconButton
