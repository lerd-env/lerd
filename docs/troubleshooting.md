...
It checks the machine, not your projects. A site's own findings, a missing database, an unwired service, a stale config cache, come from [`lerd site:doctor`](reference/commands.md), run inside the project or with its domain:
